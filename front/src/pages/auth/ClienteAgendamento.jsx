      ...
      <div>
        ...
        <div className="w-full bg-ambr-300">
          <ul className="grid grid-cols-5 gap-2 p-4 rounded-lg">
            {["08:00", "09:00", "10:00", "11:00", "12:00", "13:00"].map((hora) => (
              <label key={hora} className=" text-xl rounded-2xl border bg-white h-12 w-15 text-gray-800 font-bold cursor-pointer peer-checked:bg-white peer-checked:text-blue-500">
                <input
                  type="checkbox"
                  className="hidden peer"
